...
background_image = load_image('treasure_box.jpg')
open_box_image = load_image('open_box.jpg')
fish_image = load_image('fish.jpg', scale=(400, 400))
bubble_image = load_image('speech_bubble.png', scale=(300, 150))  # Adjust bubble scale if needed
